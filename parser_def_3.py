...
class DefParser:
    ...
    def __init__(self):
        ...
        if not self.ignore_pins:
            self.sections_grp.append(['pins'])

        if not self.ignore_specialnets:
            self.sections_grp.append(['specialnets'])
    ...
    def parser_def(self, file_string):
        ...
        for sections in self.sections_grp:
            self.parse_sections(sections, file_string, shared_dict)
